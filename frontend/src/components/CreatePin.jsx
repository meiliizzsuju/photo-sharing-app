...
const CreatePin = ({ user }) => {
  ...
  const [wrongImageType, setWrongImageType] = useState(false); // if wrong image size
    ...
    if (title && about && destination && imageAsset?._id && category) {
      const doc = {
        ...
        image: {
          ...
          asset: {
            _type: 'reference',
            _ref: imageAsset?._id, // img store as asset on Sanity
          },
        },
        userId: user._id,
        posted: {
                ...
                <div className='flex flex-col items-center justify-center h-full'>
                  <div className='flex flex-col justify-center items-center'>
                    ...
                    <p className="mt-32 text-gray-400 text-sm">
                      Use high-quality JPG, JPEG, SVG, PNG or GIF
                    </p>
                  </div>
                </div>
                <input
